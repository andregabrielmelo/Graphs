...
public class UnitTest1
{
    ...
    public void Test1()
    {
        // TODO: separate these tests into multiple test methods and use assertions instead of console output
        ...
        List<Vertex> vertexDirectTransitiveClouse = graph.VertexDirectTransitiveClosure(
            graphVertex
        );
        List<Vertex> vertexIndirecttransitiveClouse = graph.VertexInverseTransitiveClosure(
            graphVertex
        );
        Console.WriteLine(
        ...
        foreach (var algorithm in algorithms)
        {
            ...
            try
            {
                ...
                Console.WriteLine(
                    $"Cost from {startVertex.Name} to {endVertex.Name}: {path.Count}"
                );
